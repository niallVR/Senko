...
/// <summary>
/// Extensions for the <see cref="short"/> struct.
/// </summary>
public static class ShortExtensions {
    ...
    public static bool IsInRange(this short number, long min, long max, bool inclusive) {
    ...
    /// <returns>True if the value is in the range, false if not.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsInRange(this ushort number, ulong min, ulong max, bool inclusive = true) {
        return inclusive ? min <= number && number <= max : min < number && number < max;
    }
}