...
public class DateOnlyProvider : IDateOnly
{
    ...
    public DateOnly Parse(ReadOnlySpan<char> s, IFormatProvider? provider = default,
    ...
    public DateOnly ParseExact(ReadOnlySpan<char> s, ReadOnlySpan<char> format, IFormatProvider? provider = default,
        DateTimeStyles style = DateTimeStyles.None)
    {
    ...
    public DateOnly ParseExact(ReadOnlySpan<char> s, string[] formats, IFormatProvider? provider,
        DateTimeStyles style = DateTimeStyles.None)
    {
    ...
    public DateOnly ParseExact(string s, string[] formats, IFormatProvider? provider,
        DateTimeStyles style = DateTimeStyles.None)
    {
        return DateOnly.ParseExact(s, formats, provider, style);
    }
    ...
    public bool TryParseExact(ReadOnlySpan<char> s, string?[]? formats, IFormatProvider? provider, DateTimeStyles style,
        out DateOnly result)
    {
