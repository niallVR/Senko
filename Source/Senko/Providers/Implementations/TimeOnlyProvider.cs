...
public class TimeOnlyProvider : ITimeOnly
{
    ...
    public TimeOnly Parse(ReadOnlySpan<char> s, IFormatProvider? provider = default,
    ...
    public TimeOnly ParseExact(ReadOnlySpan<char> s, ReadOnlySpan<char> format, IFormatProvider? provider = default,
        DateTimeStyles style = DateTimeStyles.None)
    {
    ...
    public TimeOnly ParseExact(ReadOnlySpan<char> s, string[] formats, IFormatProvider? provider,
        DateTimeStyles style = DateTimeStyles.None)
    {
    ...
    public TimeOnly ParseExact(string s, string[] formats, IFormatProvider? provider,
        DateTimeStyles style = DateTimeStyles.None)
    {
        return TimeOnly.ParseExact(s, formats, provider, style);
    }
