...
public class DateTimeOffsetProvider : IDateTimeOffset
{
    ...
    public bool TryParse(string? input, IFormatProvider? formatProvider, DateTimeStyles styles,
        out DateTimeOffset result)
    {
        return DateTimeOffset.TryParse(input, formatProvider, styles, out result);
    }

    public bool TryParse(ReadOnlySpan<char> input, IFormatProvider? formatProvider, DateTimeStyles styles,
        out DateTimeOffset result)
    {
        return DateTimeOffset.TryParse(input, formatProvider, styles, out result);
    }

    public bool TryParseExact(string? input, string? format, IFormatProvider? formatProvider, DateTimeStyles styles,
        out DateTimeOffset result)
    {
        return DateTimeOffset.TryParseExact(input, format, formatProvider, styles, out result);
    }

    public bool TryParseExact(ReadOnlySpan<char> input, ReadOnlySpan<char> format, IFormatProvider? formatProvider,
        DateTimeStyles styles, out DateTimeOffset result)
    {
        return DateTimeOffset.TryParseExact(input, format, formatProvider, styles, out result);
    }

    public bool TryParseExact(string? input, string?[]? formats, IFormatProvider? formatProvider, DateTimeStyles styles,
        out DateTimeOffset result)
    {
        return DateTimeOffset.TryParseExact(input, formats, formatProvider, styles, out result);
    }

    public bool TryParseExact(ReadOnlySpan<char> input, string?[]? formats, IFormatProvider? formatProvider,
        DateTimeStyles styles, out DateTimeOffset result)
    {
        return DateTimeOffset.TryParseExact(input, formats, formatProvider, styles, out result);
    }
