...
public interface IDateTime
{
    ...
    DateTime ParseExact(ReadOnlySpan<char> s, ReadOnlySpan<char> format, IFormatProvider? provider,
        DateTimeStyles style = DateTimeStyles.None);

    /// <inheritdoc cref="DateTime.ParseExact(ReadOnlySpan{char}, string[], IFormatProvider?, DateTimeStyles)"/>
    DateTime ParseExact(ReadOnlySpan<char> s, string[] formats, IFormatProvider? provider,
        DateTimeStyles style = DateTimeStyles.None);
